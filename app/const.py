fuel_types = ['petrol','diesel','hybrid_petrol', 'hybrid_diesel', 'plug_in_hybrid_petrol', 'plug_in_hybrid_diesel', 'electric', 'lpg', 'cng','other']
